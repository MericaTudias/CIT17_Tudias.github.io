...
<?php
    ...
    if(isset($_POST["studentid"]) && isset($_POST["firstname"]) && isset($_POST["lastname"]) && isset($_POST["dateofbirth"]) && isset($_POST["email"]) && isset($_POST["phone"])){
        ...
        $email = $_POST['email'];
        $phone = $_POST['phone'];
        $sql = "UPDATE student SET `studentid`= '$studentid', `firstname`= '$firstname', `lastname`= $lastname, `dateofbirth`= $dateofbirth,`email`= $email, `phone`= $phone WHERE studentid= ".$_GET["studentid"];
...
<body>
    <section>
        ...
        <div class="container">
            <?php 
                require_once "Connect.php";
                $sql_query = "SELECT * FROM student WHERE studentid = ".$_GET["StudentID"];
